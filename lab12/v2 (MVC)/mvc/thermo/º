...
public class ThermometerApp {
	/**
	 * The main program creates the user interface for the thermometer application
	 * and creates an initial thermometer.
	 * 
	...
	public static void main(String[] args) {
		...
		DigitalDisplay thermometerDisplay2 = new DigitalDisplay(thermometer);
  		SouUmaView view = new SouUmaView(thermometer);
		...
		thermometer.addThermometerListener(view);
